...
![ Droplet transmission through face masks. Each data point represents the relative droplet count (RDC) compared with no mask. The lower the RDC, the more droplets are blocked by the mask and increased the filtration efficiency](images/OC1_3-2_Fig1.png) 
